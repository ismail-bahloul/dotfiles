...
| [`material-you.md`](material-you.md) | How the wallpaper-driven theming works (kitty / btop / prompt), the KWin transparency and blur setup, and the two things that break after updates. |
